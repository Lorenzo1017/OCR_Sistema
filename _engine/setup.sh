...
alias ocr-telegram='"$PY" "$ENGINE/telegram_bot.py"'
alias ocr-manutenzione='"$PY" "$ENGINE/manutenzione.py"'
alias ocr-backup-db='"$PY" "$ENGINE/backup_db.py"'
...
alias ocr-duplicati='"$PY" "$ENGINE/duplicati.py"'
